    ...
    return (
        <section id="projects">
            <div className="flex min-h-0 flex-col gap-y-8">
                <div className="max-w-2xl mx-auto flex flex-col gap-y-4 items-center justify-center">
                    ...
                    <div className="flex flex-col gap-y-3 items-center justify-center">
                        ...
                        <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
                            I&apos;ve worked on a variety of games. Here are a few of my
                            favorites.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 max-w-[800px] mx-auto auto-rows-fr">
                    {DATA.projects.filter((project) => project.image_h==='108p').map((project, id) => (
                        <BlurFade
                            key={project.title}
                            delay={BLUR_FADE_DELAY * 12 + id * 0.05}
                            className="h-full"
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 max-w-[800px] mx-auto auto-rows-fr">
                    {DATA.projects.filter((project) => project.image_h==='56p').map((project, id) => (
                        <BlurFade
                            key={project.title}
                            delay={BLUR_FADE_DELAY * 12 + id * 0.05}
                            className="h-full"
